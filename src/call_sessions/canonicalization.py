"""Canonical snapshots and stable hashes for call lifecycle sessions."""
...
def to_canonical_data(value: Any, *, exclude_none: bool = True) -> Any:
    """Convert supported values into stable JSON-compatible data."""
...
def canonical_snapshot(value: Any, *, exclude_none: bool = True) -> dict[str, Any]:
    ...
    if not isinstance(data, dict):
        msg = "Canonical call session snapshots must be dictionaries."
        raise TypeError(msg)
    return data
...
def stable_fingerprint(
    ...
    *,
    ...
    """Create a stable SHA-256 fingerprint for reproducible lifecycle records."""
